...
* A user cannot create a post using special characters or numbers in the title
...
* A user cannot edit a post using special characters or numbers in the title
